...
public class ForceLightningManager : MonoBehaviour
{
    ...
    public void StartForceLightning()
    {
        ...
        {
            forceLightning = Instantiate(forceLightningPrefab, new Vector3(hand.position.x - lightningOffset, hand.position.y + lightningOffset, hand.position.z), Quaternion.identity);
