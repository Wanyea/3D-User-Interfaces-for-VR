...
public class ForceLightningManager : MonoBehaviour
{
    ...
    public void StartForceLightning()
    {
        ...
        {
            forceLightning = Instantiate(forceLightningPrefab, new Vector3(hand.position.x, hand.position.y + yLightningOffset, hand.position.z + lightningOffset), Quaternion.identity);
