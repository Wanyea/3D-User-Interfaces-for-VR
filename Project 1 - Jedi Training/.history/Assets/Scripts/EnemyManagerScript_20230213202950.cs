...
public class EnemyManagerScript : MonoBehaviour
{
    ...
    void Start()
    {
        Instantiate(practiceDroid, new Vector3(practiceDroidSpawn.x, practiceDroidSpawn.y + 10, practiceDroidSpawn.z), Quaternion.identity);
    }
    ...
    public bool isPracticeDroidDefeated() 
    {
        if (!practiceDroid) 
        {
