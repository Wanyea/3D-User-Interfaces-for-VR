...
public class EnemyManagerScript : MonoBehaviour
{
    ...
    void Start()
    {
        Instantiate(practiceDroid, new Vector3(practiceDroidSpawn.transform.position.x, practiceDroidSpawn.position.y + 10, practiceDroidSpawn.position.z), Quaternion.identity);
    }
