...
public struct Gesture
{
    ...
    public List<Vector4> handRotation;
...
public class GestureDetector : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (debugMode && Input.GetKeyDown("space"))
        {
    ...
    void Save()
    {
        ...
        List<Vector3> handTransform = new List<Vector3>();
        ...
        foreach (var bone in fingerbones)
        {
            ...
            handTransform.Add(skeleton.transform.InverseTransformPoint(bone.Transform.rotation));
        }

        // after the foreach we are going to associate the list of Vector3 to the one we create from the struct "g"
        g.fingerDatas = data;
        g.handRotation = handTransform;
    ...
    Gesture Recognize()
    {
        ...
        float currRotMin = Mathf.Infinity;
        ...
        foreach (var gesture in gestures)
        {
            ...
            for (int i = 0; i < fingerbones.Count; i++)
            {
                ...
                Vector3 currRot = skeleton.transform.InverseTransformPoint(fingerbones[i].Transform.rotation);
                ...
                float rotDistance = Vector3.Distance(currRot, gesture.handRotation[i]);
